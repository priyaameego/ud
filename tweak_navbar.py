...
new_nav2_top_html = '''  <!-- Navbar 2 Top Row (Support & Login) -->
  <div class="w-full transition-all duration-300 nav2-top-row overflow-hidden border-b border-gray-100" style="height: 0; opacity: 0; padding: 0;">
    <div class="max-w-7xl mx-auto px-4 flex items-center justify-between pt-2 pb-1">
      ...
      <div class="hidden md:flex items-center gap-4 lg:gap-8 shrink-0">
        <div class="flex items-center gap-3 shrink-0">
          <div class="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center shrink-0"><i class="fas fa-envelope text-gray-600 text-sm"></i></div>
        ...
        <a href="contact.html" class="bg-[#5a4fcf] text-white font-bold py-2.5 px-8 rounded-lg shadow-md hover:bg-[#4b42b4] transition-colors text-sm tracking-wide shrink-0">Login</a>
      </div>
    </div>
  </div>
